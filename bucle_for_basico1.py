...
print("3. Contando Vanilla Ice:\n","a. imprime los números enteros del 1 al 100.",sep="   ")
...
print("suma los números pares del 0 al 500,000 e imprime la suma total. (Sorpresa, será un número gigante).")
suma=0
...
print("Por ejemplo: si numInicial = 3, numFinal = 10, y multiplo = 2, el bucle debería de imprimir 4, 6, 8, 10 (en líneas sucesivas).")
